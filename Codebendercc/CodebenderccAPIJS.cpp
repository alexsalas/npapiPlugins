...
FB::variant CodebenderccAPI::flash(const std::string& device,
...
FB::variant CodebenderccAPI::flashWithProgrammer(const std::string& device,
                                                const std::string& code,
                                                const std::string& maxsize,
